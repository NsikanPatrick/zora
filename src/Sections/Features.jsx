...
import { features, details } from "../Constants/index"; //Import retrieves 1st frm index, hence we didnt need to specify index.js
    ...
    <section>
      <Element name="features">
        <div className="container">
          ...
          rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3"
          >
            {/* Instead of doing feature.icon... everytime within the loop, we destructure it as below */}
              ...
              >
                <div className="w-full flex justify-start items-start">
                  <div className="-ml-3 mb-12 flex items-center justify-center flex-col">
                    ...
                    {/* A litle designer line connecting to the icon */}
                ...
                <h2 className="max-w-400 mb-7 h3 text-p4 max-md:mb-6 max-md:h5 lg:text-[34px]">{title}</h2>
                <p className="mb-11 body-1 max-md:mb-8 max-md:body-3 lg:text-[20px]">{text}</p>
