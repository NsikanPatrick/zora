...
const Header = () => {
  ...
  const NavLink = ({ title }) => (
    <LinkScroll
      ...
      className="base-bold text-p4 uppercase transition-colors duration-500 hover:text-p1 cursor-pointer max-lg:my-4 max-lg:h7"
    >
      {title}
    </LinkScroll>
  );
  ...
  return (
    <div>
      {/* Apply the 1st set of classes by default, but apply the 2nd set once the window gets to 32px as is defnd on the useEffect function */}
      <header
        className={`fixed top-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4 ${
        ...
        <div className="container flex items-center h-14 max-lg:px-5">
          ...
          max-md:px-4"
            >
              ...
              <div className="mobile-sidebar-bg lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
                <img
