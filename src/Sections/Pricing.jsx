      ...
      <Element name="pricing">
        <div className="container">
          <div className="pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            <h3 className="h4 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-10 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm">
            ...
            <div className="pricing-bg">
              ...
              <img
                ...
                height={380}
                alt="outline"
                className="absolute insert-0 opacity-5 mix-blend-soft-light"
              />
            </div>
          </div>
          {/* Pricing section */}
          <div className="scroll-hide relative z-2 -mt-36 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
